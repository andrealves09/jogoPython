...
canto01_img= pygame.image.load('img/canto01.png')
canto02_img= pygame.image.load('img/canto02.png')
#load sounds
...
def reset_level(level):
	...
	player2.reset(30, screen_height - 130)
	blob_group.empty()
...
player2 = Player2(25, screen_height-80)
